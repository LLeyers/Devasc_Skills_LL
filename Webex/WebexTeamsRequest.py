...
access_token = "MzY0Zjg5ZWMtZTAxYy00NWEwLTkzY2EtMGZhOWE3YjlmMjM4MTY5YzBiYmUtMjU4_P0A1_71b6b34c-abff-4407-ac50-5e62323aed80"

groups_struc = {
 "groups": [
      { "group": { "group_id": "G1" , "group_name": "devasc_skills_LL" ,
                   "members": [
                     {"person_id": "P-1" , "person_name": "Luca", "email": "Luca.Leyers@student.odisee.be"},
